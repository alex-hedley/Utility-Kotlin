...
fun SQLContainsView() {
    ...
    Column(
            ...
            Text("🔍 SQL CONTAINS Clause", style = MaterialTheme.typography.titleLarge)
            ...
            Row() {
                Column() {
                    Checkbox(
                        checked = wildcard,
                        onCheckedChange = { wildcard = it },
                    )
                }
                Column() {
                    Text(text = "Include Wildcard")
                }
            }
            ...
            Row() {
                Column() {
                    TextField(
                        ...
                        placeholder = { "FirstName LIKE %Alex%" },
                        label = { Text("Input") },
                        singleLine = false,
                    )
                }
