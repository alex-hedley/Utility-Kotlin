...
/**
 * Manages the state of the expandable navigation rail.
 *
 * @param initialExpanded Whether the rail should be initially expanded.
 */
...
fun rememberNavigationRailState(
    initialExpanded: Boolean = false
): NavigationRailState = remember { NavigationRailState(initialExpanded) }
